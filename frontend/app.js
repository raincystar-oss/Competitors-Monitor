...
const ui = {
    ...
    renderTextAnalysis(analysis) {
        const informativeContent = Number.isFinite(analysis.informative_content)
            ? analysis.informative_content
            : 0;
        const informativePercent = Math.max(0, Math.min(10, informativeContent)) * 10;
        ...
        return `
            <div class="result-block">
                <h3>
                    ...
                    Оценка информативности контента
                </h3>
                <div class="score-display">
                    <span class="score-value">${informativeContent}/10</span>
                    <div class="score-bar">
                        <div class="score-fill" style="width: ${informativePercent}%"></div>
                    </div>
                </div>
                <p>${analysis.informative_content_analysis || ''}</p>
            </div>
    ...
    renderImageAnalysis(analysis) {
        ...
        const designScore = Number.isFinite(analysis.design_score) ? analysis.design_score : 0;
        const designPercent = (Math.max(0, Math.min(10, designScore)) / 10) * 100;
        ...
        return `
            ...
            <div class="result-block">
                ...
                <div class="score-display">
                    <span class="score-value">${designScore}/10</span>
                    <div class="score-bar">
                        <div class="score-fill" style="width: ${designPercent}%"></div>
                    </div>
                </div>
                <p>${analysis.design_analysis || ''}</p>
            </div>
