...
class CompetitorAnalysis(BaseModel):
    ...
    informative_content: int = Field(0, ge=0, le=10, description="Оценка информативности контента (0-10)")
    informative_content_analysis: str = Field("", description="Анализ информативности контента")
